                    ...
                    <table class="table table-striped table-hover">   
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td>Joe Borg</td>
                                <td>joeborg@gmail.com</td>
                                <td>12345678</td>
                                <td>29th February</td>
                                <td>
                                    <a href="#" class="show"><i class="material-icons" data-toggle="tooltip" title="Show">visibility</i></a>                                            
                                    <a href="#" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="#" class="btn-delete delete" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">2</th>
                                <td>Jane Marith</td>
                                <td>janemairth@gmail.com</td>
                                <td>87654321</td>
                                <td>10th December</td>
                                <td>
                                    <a href="#" class="show"><i class="material-icons" data-toggle="tooltip" title="Show">visibility</i></a>                                            
